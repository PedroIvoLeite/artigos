...
\sloppy
% evitar que as palavras excedam a margem
...
% ||||||||||||||||||||||||||||||||||||||||||||||
\input{capitulos/2-fundamentacao}


% ||||||||||||||||||||||||||||||||||||||||||||||
% CAPITULO 3 - TRABALHOS
% ||||||||||||||||||||||||||||||||||||||||||||||
\input{capitulos/3-trabalhos_relacionados}
...
% ||||||||||||||||||||||||||||||||||||||||||||||
% CAPITULO 5 - RESULTADOS PRELIMINARES
% ||||||||||||||||||||||||||||||||||||||||||||||
